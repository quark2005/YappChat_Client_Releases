...
class ClientGUIHomepage:
    ...
    def format_select_bar(self):
        ...
        self.leave_room_button = tk.Button(self.left_frame, text="Leave Room", font=("Arial", 15),
                                           command=lambda: ClientGUILeaveRoomPage.open_window(self, self.client_sender))
...
class ClientGUIJoinRoomPage:
    ...
    def format_window(self):
        ...
        self.join_room_button = tk.Button(self.root, text="Join", command=self.join_room)
...
class ClientGUILeaveRoomPage:
    ...
    def format_window(self):
        ...
        self.leave_room_button = tk.Button(self.root, text="Leave", command=self.leave_room)
        self.leave_room_button.place(width=100, height=100, x=10, y=10)

    def leave_room(self):
        self.client_sender.send_message("leave_room")
    ...
    def open_window(homepage: ClientGUIHomepage, client_sender: Sender.ClientSender):
        if not homepage.isLeaveRoomWinOpen:
            ...
            homepage.leave_room_page = ClientGUILeaveRoomPage(homepage, client_sender)
